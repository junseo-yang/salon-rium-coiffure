export function compileAppointmentConfirmationCustomerTemplate(
    id: string,
    price: string,
    status: string,
    from_date: Date,
															...
															<tr>
																<td class="pad" style="padding-bottom:10px;padding-left:30px;padding-right:30px;padding-top:10px;">
																	<div style="color:#393d47;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;line-height:150%;text-align:left;mso-line-height-alt:24px;">
																		...
																		<p style="margin: 0; word-break: break-word;"><span>Your appointment has been confirmed in our Salon Rium Coiffure </span><span>on ${current.toLocaleString(
                                                                            "en-US",
                                                                            {
                                                                                timeZone:
                                                                                    "America/New_York",
