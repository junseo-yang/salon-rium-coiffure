...
import { Duration, Interval, ServiceCategory, Staff } from "@prisma/client";
...
const ServiceModal = ({
    ...
    const [interval, setInterval] = useState(Interval.M60.toString());
    const [duration, setDuration] = useState(Duration.M60.toString());
    ...
    const [staffIds] = useState(new Set<string>());
...
export function useServiceModal(staffs: Staff[]) {
